/***************************** */
// Alan Beecroft
// Human Friendly Clock part one
/***************************** */

// instantiation of Date object
const d = new Date();

// initiation on the necessary variables for the clock functionality
let hour = d.getHours();
let minutes = d.getMinutes();
//let hour_text = ""

// A series of if conditionals to illicit the text for the hour
if(hour == 1 || hour == 13) 
  hour_text = "One"
